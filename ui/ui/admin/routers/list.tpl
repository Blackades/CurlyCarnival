        ...
        <div class="box box-primary shadow-md mb-4">
            <div class="box-header with-border py-3">
                <div class="btn-group pull-right">
                    <a class="btn btn-primary btn-sm shadow-sm" title="save" href="{Text::url('')}routers/maps">
                        <span class="glyphicon glyphicon-map-marker"></span></a>
                </div>
                <h3 class="box-title">{Lang::T('Routers')}</h3>
            </div>
            <div class="box-body">
                <div class="search-filter-container bg-light p-4 rounded-md mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <a href="{Text::url('')}routers/add" class="btn btn-primary btn-block shadow-sm"><i
